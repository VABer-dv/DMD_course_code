            ...
            <div class="row row-offcanvas row-offcanvas-left">
                <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
                    ...
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="active"><a href="/citatki.php">Citations</a></li>
                    </ul>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-success">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">Add new record to the "Citate" table </h4>
                                </div>
                                <div class="modal-body">
                                    <label for="publ-name" class="control-label">Citate</label>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-warning">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title" id="myModalLabel">Update record(s) in the "Citations" table </h4>
                                </div>
                                <div class="modal-body">

                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="publ-name" class="control-label">Citation:</label>
                                            <input type="text" class="form-control" id="publ-name-up">
                                        </div>
                                    
                                        <div class="col-md-6">
                                            <label for="publ-name-new" class="control-label">New citation:</label>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header bg-danger">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title" id="myModalLabel">Delete record(s) from the "Citations" table </h4>
                                </div>
                                <div class="modal-body">
...
<!------------------------------------ Show Records Script ------------------------------------>
                    <script>
                        ...
                        $(document).on('click', ".page", function (event) {
                            ...
                            $("#loader").show();
                            var fil_pub = document.getElementById("fil_pub").value;
                            var fil_kw = document.getElementById("fil_kw").value;
                            var page = $(this).text();
                            var flag = 1;
                            $.ajax({
                                type: "POST",
                        ...
                        $(document).on('input', '#fil_pub', filtering);
                        
                        $(document).on('input', '#fil_kw', filtering);
